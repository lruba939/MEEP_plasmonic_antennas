...
def run():
    ...
    # SIM_NAME = "TEST-splitbar-AuTiSiO2-gap-{int(gap)}nm-lambda-8100nm-L-1800nm"
    # #############################
    # 
    ...
    # task_8()
     ...
     for gap in gaps:
         ...
         ### Set paths to save results
         SIM_NAME = f"splitbar-AuTiSiO2-gap-{int(gap)}nm-lambda-8100nm-L-1800nm"
         #############################
